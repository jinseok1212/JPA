...
public class Memo {
    ...
    //엔티티를 정의하면, 하이버네이트가 DDL구문을 알아서 대신 실행해주는데 spring.jpa.hibernate.ddl-auto=update 옵션덕분에 적용이 됨
    @Id //pk
...
//    @SequenceGenerator(name = "이름", sequenceName = "시퀀스명", initialValue = 1, allocationSize = 1)
    ...
    @Column(columnDefinition = "varchar(200) default 'y'")//만들고싶은 컬럼 제약을 직접 명시
    private String text;
